...
ruta = r'D:\Python Proy\TP_PDI\pdi1-2026\TP1\Codigo\Imagen_con_detalles_escondidos.tif'
...
def ecualizacion_local(img, M, N):
    ...
    # Agregamos el borde replicando el último píxel, como sugiere el TP
...
# Calculamos los 3 CDFs (asumiendo que ya corriste la función local)
